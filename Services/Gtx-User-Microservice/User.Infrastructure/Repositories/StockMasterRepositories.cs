...
{
    public class StockMasterRepositories : RepositoryBase<StockMaster>, IStockMasterRepository
    {
        public StockMasterRepositories(SqlContext dbContext) : base(dbContext)
        {
        }
